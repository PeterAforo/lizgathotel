...
async function main() {
  ...
  const roomsData = [
    ...
    },
    {
      ...
      amenities: ["Free Wi-Fi", "Climate Control", '65" Smart TV', "Premium Mini Bar", "24/7 Room Service", "Luxury Bathrobe & Slippers", "Jacuzzi", "Rose Petal Turndown", "Champagne Welcome", "Private Balcony", "Complimentary Breakfast"],
      featured: false,
      sortOrder: 5,
    },
  ];
  ...
  const testimonialsData = [
    ...
    { name: "Sarah Mitchell", location: "London, UK", rating: 5, text: "LIZGAT Hotel exceeded all expectations. The blend of Ghanaian hospitality with world-class service is remarkable. The dining experience was divine, and the restaurant served the best jollof rice I've ever tasted.", avatar: "SM", sortOrder: 1 },
    ...
    { name: "Aisha Johnson", location: "New York, USA", rating: 5, text: "What a gem in Accra! The hotel grounds are stunning, the rooms are impeccably clean, and the concierge helped us plan the most amazing tour of the city. Highly recommended for any traveler!", avatar: "AJ", sortOrder: 3 },
